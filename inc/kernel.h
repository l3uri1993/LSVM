...
typedef float (*lasvm_kernel_t)(int i, int j, void* closure);
#endif
...
typedef struct lasvm_vectorproblem_s 
{
  ...
  float *y;			/* category */
  float *xnorm;		/* for rbf kernel: l2-norm of the x[i] */
  float rbfgamma;		/* for rbf kernel: gamma */
} lasvm_vectorproblem_t;


float lasvm_vectorproblem_lin_kernel(int i, int j, void *problem);

float lasvm_vectorproblem_rbf_kernel(int i, int j, void *problem);
...
float lasvm_sparsevectorproblem_lin_kernel(int i, int j, void *problem);

float lasvm_sparsevectorproblem_rbf_kernel(int i, int j, void *problem);
