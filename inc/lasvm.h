...
int lasvm_process( lasvm_t *self, int xi, float y );
...
*/
int lasvm_reprocess(lasvm_t *self, float epsgr);
...
*/
int lasvm_finish(lasvm_t *self, float epsgr);

/* -- lasvm_get_cp, lasvm_get_cn
   Returns the values of parameter C for positive 
   and negative examples.
*/
float lasvm_get_cp( lasvm_t *self );
float lasvm_get_cn( lasvm_t *self );
...
*/
float lasvm_get_delta(lasvm_t *self);
...
*/
int lasvm_get_alpha(lasvm_t *self, float *alpha);
